...
public class loginuser extends AppCompatActivity implements  View.OnClickListener,AdapterView.OnItemSelectedListener {
    ...
    public void onClick(View view) {
        ...
        switch (id){
            ...
            case R.id.loginreg:
                Intent login1=new Intent(loginuser.this,RegisterUser.class);
    ...
    public void loginn() {
        ...
        if (TextUtils.isEmpty(emaill) || TextUtils.isEmpty(pass)) {
            ...
            Toast.makeText(loginuser.this, "Empty fields", Toast.LENGTH_LONG).show();
        } else {mprogress.setMessage("Login");
            mprogress.show();
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Intent login=new Intent(loginuser.this,Main3Activity.class);
            login.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
               startActivity(login);

        } else {
            Toast.makeText(loginuser.this, "Please login.",
                    Toast.LENGTH_SHORT).show();
        }
    }
    @Override
